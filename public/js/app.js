...
async function autoTagNote(noteText) {
  ...
  try {
    ...
    const response = await fetch('/api/anthropic/auto-tag', {
      method: 'POST',
      headers: {
    ...
    if (response.ok) {
      ...
      throw new Error('Failed to auto-tag note');
    }
  } catch (error) {
...
async function queryNotes(question) {
  ...
  try {
    ...
    const response = await fetch('/api/anthropic/query', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
      body: JSON.stringify({ question, notes: selectedNotes }),
    });
...
async function summarizeNotes() {
  ...
  try {
    ...
    const response = await fetch('/api/anthropic/summarize', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
      body: JSON.stringify({ notes: selectedNotes, summaryLength }),
    });
...
async function surfaceInsights() {
  ...
  try {
    ...
    const response = await fetch('/api/anthropic/insights', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
      body: JSON.stringify({ notes: selectedNotes, insightsType }),
    });
    ...
    if (response.ok) {
      ...
      throw new Error('Failed to surface insights');
    }
  } catch (error) {
